...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi_blocker(
        ...
        KC_LGUI, KC_LCTL, KC_LALT,                            KC_SPC ,                            KC_RALT, FN_PLAY, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_65_ansi_blocker(
        ...
        _______,          _______, _______, _______, _______, QK_BOOT, _______, _______, _______, _______, _______, _______, _______, KC_END ,
        _______, _______, _______,                            _______,                            _______, _______, KC_MPRV, KC_MNXT, KC_UP
    ),
